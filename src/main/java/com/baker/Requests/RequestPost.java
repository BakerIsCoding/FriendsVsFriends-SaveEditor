...
public class RequestPost {
    ...
    public void postGameSaveData(String userAuthToken, String[] bodyThingsToSend) {
        try { // falta acabar
            ...
            JSONObject finalRequest = new JSONObject("{\"character\":\"" + bodyThingsToSend[0] +"\",\"bots\":0,\"gamemode\":0,\"map\":0,\"result\":1,\"ragequit\":0,\"hits\":"+bodyThingsToSend[5]+",\"misses\":"+bodyThingsToSend[6]+",\"headshots\":1,\"levelDifference\":22,\"cardsUsedCount\":2,\"roundsWon\":"+bodyThingsToSend[3]+",\"perfectRounds\":0,\"cardsUsed\":{\"44\":1,\"90\":1},\"myTeamMmr\":[{\"mu\":25.4,\"sigma\":8.3333,\"rating\":0.0}],\"otherTeamMmr\":[{\"mu\":30.1608162,\"sigma\":3.72432184,\"rating\":0.0}],\"localPlayerIndex\":0,\"newCardsSeen\":[11,71],\"extraBonus\":[],\"roundsWithUsedCards\":1,\"rounds\":"+bodyThingsToSend[4]+",\"canGetFirstBlood\":false,\"kills\":"+bodyThingsToSend[1]+",\"deaths\":"+bodyThingsToSend[2]+",\"Accuracy\":0.6666667}");
